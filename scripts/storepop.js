...
actions = [
  ...
  function(callback) { Store.sadd('composed_deceptive_fragment', [ '<p>Your deceptive statement has been left as a trap for your <a href="#" onclick="return Utilities.popup(\'{{fb_dialog}}\', 400, 580)">unsuspecting friends</a>..</p>', '<p>We\'ve added your deceptive statement to the mix, where it will lie in wait for your <a href="#" onclick="return Utilities.popup(\'{{fb_dialog}}\', 400, 580)">gullible buddies</a>.</p>' ], callback); },
