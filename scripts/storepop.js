...
actions = [
  ...
  function(callback) { Store.sadd('composed_deceptive_fragment', [ '<p>Your deceptive statement has been left as a trap for your <a href="#" class="popup" data-link="{{fb_dialog}}">unsuspecting friends</a>..</p>', '<p>We\'ve added your deceptive statement to the mix, where it will lie in wait for your <a href="#" class="popup" data-link="{{fb_dialog}}">gullible buddies</a>.</p>' ], callback); },
