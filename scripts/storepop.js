...
actions = [
  ...
  function(callback) { Store.del('composed_deceptive_fragment', callback); },
  function(callback) { Store.sadd('composed_deceptive_fragment', [ '<p>Your deceptive statement has been left as a trap for your unsuspecting pals.<br /><a href="#" class="btn btn-primary popup" data-link="{{fb_dialog}}">Invite</a> some chumps</a></p>', '<p>We\'ve added your deceptive statement to the mix, where it will lie in wait for your gullible buddies.<br /><a href="#" class="popup btn btn-primary" data-link="{{fb_dialog}}">Invite some chumps</a></p>' ], callback); },
