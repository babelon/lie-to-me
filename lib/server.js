...
var fs, path, express, Mongoose, invocation, Store, Storage, Auth, Points, log_dir;
...
server.configure(function() {
  ...
  server.use(require('./auth').enforcer({
    ...
    whitelist: [ '^/([?#].*)?$', '^/login', '^/logout', '^/scripts', '^/styles', '^/images', '^/profiles', '^/canvas' ]
  }));
  server.use(Storage.middleware);
