...
exports.star_5_statement_request = "You've never {{actioned}} {{{ entity }}}? Well, pretend that you have. And that you loved it.";
exports.star_4_statement_request = "You've never {{actioned}} {{{ entity }}}? Well, pretend that you have, and  thought it was pretty good.";
exports.star_3_statement_request = "You've never {{actioned}} {{{ entity }}}? Well, pretend that you have, and thought it was average.";
exports.star_2_statement_request = "You've never {{actioned}} {{{ entity }}}? Well, pretend that you have, and thought you thought it was pretty bad.";
exports.star_1_statement_request = "You've never {{actioned}} {{{ entity }}}? Well, pretend that you have. And that you hated it.";

exports.prob_continuation_compose = 0.4;
...
// points
exports.points_correct_guess = 10;
exports.points_compose = 15;
