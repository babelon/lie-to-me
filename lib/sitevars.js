...
// star ratings
exports.star_empty_snippet = '{{#range}}<label class="rating"> <input name="star-rating" type="radio" value="{{ rating }}" {{ checked }}/> <i class="icon-star-empty"></i> </label>{{/range}}';
exports.star_filled_snippet = '{{#range}}<label class="rating"> <input name="star-rating" type="radio" value="{{ rating }}" {{ checked }}/> <i class="icon-star"></i> </label>{{/range}}';
