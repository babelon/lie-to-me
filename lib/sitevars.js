...
exports.leaders_submitted = ['Thanks!', 'Thank you!'];

exports.truth_guessed_truth = '<p>You called it. That was the genuine article.<br />{{{ author }}} was being sincere.</p>';
exports.truth_guessed_lies = "<p>A bit too paranoid, there.<br />{{{ author }}} was telling the truth.</p>";
exports.lies_guessed_truth = "<p>Don't believe everything you read.<br />{{{ author }}} has never even {{actioned}} {{{entity}}}!</p>";
exports.lies_guessed_lies = "<p>Good catch!<br />{{{ author }}} was trying to trick you. But you didn't fall for it.</p>";

exports.submitted_authentic_fragment = "We've added your statement to the mix.";
exports.submitted_deceptive_fragment = "Your deceptive statement has been left as a trap for your unsuspecting friends...";
