...
exports.define = function(server) {
  ...
  Fragment = new Schema({
    ...
    author: { type: Schema.ObjectId, index: true, required: true },
    entity: { type: Schema.ObjectId, index: true, required: true },
  ...
  Vote = new Schema({
    ...
    voter: { type: Schema.ObjectId, index: true, required: true }
  });
